 ...
 * @date 2020-06-11
 */
public class EnhanceDiscoveryClientRouteDefinitionLocator implements RouteDefinitionLocator {
    ...
    public EnhanceDiscoveryClientRouteDefinitionLocator(DiscoveryClient discoveryClient, DiscoveryLocatorProperties properties) {
    ...
    public Flux<RouteDefinition> getRouteDefinitions() {
        ...
        return Flux.fromIterable(discoveryClient.getServices())
                ...
                .map(instance -> {
                    ...
                    final ServiceInstance instanceForEval = new EnhanceDiscoveryClientRouteDefinitionLocator.DelegatingServiceInstance(instance, properties);
